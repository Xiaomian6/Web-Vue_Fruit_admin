<template>
  <div class="app-container">
    ...
    >
      ...
      <el-table-column :label="'认证时间'" width="180px" align="center">
        <template slot-scope="scope">
      ...
      <el-table-column :label="'操作'" align="center" width="80" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button type="danger" disabled size="mini" @click="handleUpdate(scope.row)">{{ '取消' }}</el-button>
        </template>
      </el-table-column>
    </el-table>
...
<script>
  import { successList ,updateStatus} from '@/api/authentication'
  ...
  export default {
    ...
    methods: {
      getList() { // 抓取数据api
        ...
        successList(this.listQuery).then(response => {
